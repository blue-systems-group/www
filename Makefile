...
statics:
	...
	@wget http://connect.facebook.net/en_US/sdk.js -O src/assets/js/facebook/facebook.js 2>/dev/null
	@wget https://platform.twitter.com/widgets.js -O src/assets/js/twitter/twitter.js 2>/dev/null
