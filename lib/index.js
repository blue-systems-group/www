...
var metalsmith = require('metalsmith'),
    ...
    spellingexceptions = require('../lib/spellingexceptions.js'),
		structurecheck = require('../lib/structurecheck.js'),
...
metalsmith(site_dir)
  ...
  .use(drafts())
  .use(filemetadata([
    {pattern: people_pattern, metadata: {'person': true, 'title_h1': false, 'layout': 'people/single.hbt'}, preserve: true},
  ...
  .use(failmeta())
	...
	.use(msif((argv['check'] == true), structurecheck()))
