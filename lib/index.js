...
metalsmith(site_dir)
  ...
  .use(filemetadata([
    ...
    {pattern: proposals_pattern, metadata: {'proposal': true, 'layout': 'proposals/single.hbt', 'doGithub': true}},
    {pattern: courses_pattern, metadata: {'course': true, 'layout': 'courses/single.hbt', 'doGithub': true}},
    {pattern: posts_pattern, metadata: {'post': true, 'layout': 'posts/single.hbt', 'doGithub': true, 'innerLinks': ['h3'] }}
  ]))
  .use(metadata({
