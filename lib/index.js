...
require('./setupHandlebars')(template_dir);
...
var metalsmith = require('metalsmith'),
    ...
    fixsnippets = require('./fixsnippets.js'),
    layouts = require('metalsmith-layouts'),
    sections = require('./sections.js'),
    paginate_posts = require('./paginate_posts.js'),
    ...
    spellingexceptions = require('./spellingexceptions.js'),
...
metalsmith(site_dir)
  ...
  .use(filemetadata([
    {pattern: people_pattern,
      metadata: {'person': true, 'title_h1': false, 'layout': 'people/single.hbs', 'doGithub': true},
      preserve: true},
    {pattern: projects_pattern, metadata: {'project': true, 'layout': 'projects/single.hbs', 'doGithub': true}},
    {pattern: papers_pattern, metadata: {'paper': true, 'layout': 'papers/single.hbs', 'doGithub': true}},
    {pattern: proposals_pattern, metadata: {'proposal': true, 'layout': 'proposals/single.hbs', 'doGithub': true}},
    {pattern: courses_pattern, metadata: {'course': true, 'layout': 'courses/single.hbs', 'doGithub': true}},
    {pattern: posts_pattern, metadata: {'post': true, 'layout': 'posts/single.hbs', 'doGithub': true, 'innerLinks': ['h3'] }}
  ]))
  .use(metadata({
