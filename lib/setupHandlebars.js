...
module.exports = function (template_dir) {
  handlebars.registerPartial('header',
      fs.readFileSync(path.join(template_dir, '/partials/header.hbs')).toString());
  handlebars.registerPartial('footer',
      fs.readFileSync(path.join(template_dir, '/partials/footer.hbs')).toString());
  handlebars.registerPartial('paper',
      fs.readFileSync(path.join(template_dir, '/partials/paper.hbs')).toString());
  handlebars.registerPartial('proposal',
      fs.readFileSync(path.join(template_dir, '/partials/proposal.hbs')).toString());
  handlebars.registerPartial('course',
      fs.readFileSync(path.join(template_dir, '/partials/course.hbs')).toString());
  handlebars.registerPartial('projectsandpapers',
      fs.readFileSync(path.join(template_dir, '/partials/projectsandpapers.hbs')).toString());
